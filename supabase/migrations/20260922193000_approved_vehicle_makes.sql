-- RevMate's approved vehicle-brand boundary.
-- Historical rows are preserved, but unsupported makes cannot be selected or newly created.

CREATE TABLE public.approved_vehicle_makes (
  name text PRIMARY KEY,
  sort_order integer NOT NULL UNIQUE
);

CREATE TABLE public.approved_vehicle_make_aliases (
...
DROP POLICY "Vehicle makes are public" ON public.vehicle_makes;
